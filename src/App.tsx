...
export function App() {
  ...
  const transactions = useMemo(() => {
    ...
    return rawTransactions.map(transaction => ({
      ...transaction,
      approved: approvalOverrides[transaction.id] ?? transaction.approved
    }))
  }, [paginatedTransactions, transactionsByEmployee, approvalOverrides])
      ...
      <main className="MainContainer">
        ...
        <div className="RampGrid">
          <Transactions 
            ...
            onApprovalChange={(transactionId: string, newValue: boolean) => {
